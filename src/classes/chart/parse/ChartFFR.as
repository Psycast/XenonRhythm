package classes.chart.parse {
	...
	public class ChartFFR extends NoteChart {
		...
		public function ChartFFR(inData:String, framerate:int = 30):void {
			type = NoteChart.FFR;
			
			super(inData.split("|"), framerate);
		...
		/**
		 * This method is to patch the sync data for old FFR levels, where
		 * the sync data is embedded directly into the engines instead of
		 * fixing the beatBox data. Should only be used on FFR official engine.
		 * @param	lvlid
		 * @return  Frame Offset (int)
		 */
		public function oldOffsets(lvlid:Number):int {
			switch (lvlid) {
				case 87: case 88: return -10;
				case 68: case 28: case 25: case 24: case 21: case 20: return 0;
				case 37: return 6;
				case 23: return -2;
				case 22: return 3;
				case 19: return -4;
				case 17: return 1;
				default: return lvlid <= 29 ? -6 : 0;
			}
		}
