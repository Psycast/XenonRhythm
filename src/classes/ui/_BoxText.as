package classes.ui
{
	...
	public class _BoxText extends Sprite
	{
		private var _textFormat:TextFormat = Constant.TEXT_FORMAT;
		...
		public function _BoxText(width:int = 100, height:int = 20, textformat:TextFormat = null)
		{
			super();
			/*
			this.width = width;
			...
			_input.y = -1;
			_input.width = this._width;
			_input.height = this._height;
			_input.type = "input";
